...
export default function QuickEntryCard({ title, description, image, hoverTitle, hoverDescription, onClick, style }: QuickEntryCardProps) {
  return (
    <div className={styles['entry-card']} style={style} onClick={onClick}>
      <div className={styles['default-content']}>
        ...
        <div className={styles['entry-card-info']}>
            <div className={styles['entry-card-title']}>{title}</div>
